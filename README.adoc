...
Welcome to PlanMySem! Choose a topic from the table of contents to learn about available features with examples, find answers or view a summary of the commands.
...
This user guide provides a quick start guide for you to easily setup and install PlanMySem, documentation of all the various features PlanMySem offers, frequently asked questions and a summary of the available commands. ​
