...
Sorts the entire address book according to lexicographical/colexicographical order. +
Format: `sort [ascending | asc] | [descending | desc]`

****
If no options are specified, the sort will be done in lexicographical order.
****
