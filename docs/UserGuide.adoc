...
[#img-add]
.Output after entering `add n/CS2113T Tutorial d/mon st/08:00 et/09:00 des/Topic: Sequence Diagram t/CS2113T t/Tutorial`
...
[#img-edit]
.Output after entering `edit t/CS2113T t/Tutorial nl/COM2 04-01`
...
[#img-delete]
.Output after entering `delete t/CS2113T t/Tutorial`
...
[#img-list]
.Output after entering `list n/CS2113T`
...
[#img-find]
.Output after entering `find n/CS`
...
[#img-view]
.Output after entering `view month`
...
[#img-exportFile]
.Location of _PlanMySem.ics_ file
