...
`r/`:: *recurrence.* +
    Format:
    * Select/deselect recess week: `recess`
    * Select/deselect reading week: `reading`
    * Select/deselect past dates: `past`
`l/`:: *Location.*
`des/`:: *Description.*
`t/`:: *Tag.*
...
[l/LOCATION] [des/DESCRIPTION] [r/recess] [r/reading] [r/past] [t/TAG]...`
...
[NOTE]
====
If no recurrence parameters are specified then only the nearest day or the specified date is selected.
====
