...
[#img-help]
.+++<u>Output after entering `help`</u>>+++
...
[#img-add]
.**+++<u>Output after entering `add n/CS2113T Tutorial d/mon st/08:00 et/09:00 des/Topic: Sequence Diagram t/CS2113T t/Tutorial`</u>+++**
...
[#img-edit]
.+++<u>Output after entering `edit t/CS2113T t/Tutorial nl/COM2 04-01`</u>+++
...
[#img-delete]
.+++<u>Output after entering `delete t/CS2113T t/Tutorial`</u>+++
...
[#img-list]
.+++<u>Output after entering `list n/CS2113T`</u>+++
...
[#img-find]
.+++<u>Output after entering `find n/CS`</u>+++
...
[#img-view]
.+++<u>Output after entering `view month`</u>+++
image::View_Command_Month_Output.png[width="790"]
{zwsp}
...
[#img-find]
.+++<u>Output after entering `clear`</u>+++
...
[#img-export]
.+++<u>Output after entering `export`</u>+++
image::Export_Command_Output_1.png[width="790"]
...
[#img-exportFile]
.+++<u>Location of PlanMySem.ics file</u>+++
