...
After forking the repo, the documentation will still have the _PlanMySem_ branding and refer to the `https://github.com/CS2113-AY1819S2-T08-3/main` repo.
...
*API* : link:{repoURL}/src/main/planmysem/ui/Gui.java[`Gui.java`]

The UI consists of a `MainWindow` that is made up of parts e.g.`commandInput`, `outputConsole` etc.
...
* Displays `commandResult` to the user via the `outputConsole`.
...
*API* :
link:{repoURL}/src/main/java/plamysem/logic/Logic.java[`Logic.java`]
...
.Overall structure of the Data Component
image::DataClassDiagram.png[width="800"]
...
*API* : link:{repoURL}/src/planmysem/data/semester/Semester.java[`Semester.java`]
...
*API* : link:{repoURL}/src/planmysem/data/slot/Slot.java[`Slot.java`]
...
=== Data Encryption / Decription feature
...
e.g. `planmysem.logic.LogicTest`, `planmysem.parse,ParserTest`
