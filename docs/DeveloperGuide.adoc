...
After forking the repo, the documentation will still have the SE-EDU branding and refer to the `https://github.com/CS2113-AY1819S2-T08-3/main` repo.
...
* User's time, efficiency and productivity is of focus, such as in a planner/calendar/scheduling application.
* Users are error prone when typing long commands.
* Users may repeat parameters due to forgetting what was previously typed.
* Users get frustrated when forced to retype commands or look for errors that they have made.
...
=== Semester, Planner, Days and Slots
